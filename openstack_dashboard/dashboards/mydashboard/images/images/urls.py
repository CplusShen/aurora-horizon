...
from openstack_dashboard.dashboards.mydashboard.images.images import views
from openstack_dashboard.dashboards.mydashboard.images import views as imgviews
