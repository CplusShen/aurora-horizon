...
class LaunchImageNG(LaunchImage):
    ...
    url = "horizon:mydashboard:images:index"
    classes = ("btn-launch", )
    ajax = False
...
class CreateImage(tables.LinkAction):
    ...
    url = "horizon:mydashboard:images:images:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditImage(tables.LinkAction):
    ...
    url = "horizon:mydashboard:images:images:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateVolumeFromImage(tables.LinkAction):
    ...
    url = "horizon:mydashboard:volumes:volumes:create"
    classes = ("ajax-modal",)
    icon = "camera"
...
class ImagesTable(tables.DataTable):
    ...
    name = tables.WrappingColumn(get_image_name,
                                 link="horizon:mydashboard:images:images:detail",
